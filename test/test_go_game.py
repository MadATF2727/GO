...
def test_check_for_self_capture_simplest_case():
    ...
    board.make_move(3, 2, 'white')
    board.make_move(3, 4, 'white')
    board.make_move(2, 3, 'white')
    board.make_move(4, 3, 'white')
    ...
    self_capture = board._check_for_self_capture(potential_move, black)
    assert self_capture
...
def test_check_for_self_capture_single_chain_self_capture_true():
    ...
    board.make_move(4, 2, 'white')
    board.make_move(4, 3, 'white')
    board.make_move(4, 4, 'white')
    board.make_move(4, 5, 'white')
    board.make_move(5, 1, 'white')
    board.make_move(5, 6, 'white')
    board.make_move(6, 2, 'white')
    board.make_move(6, 3, 'white')
    board.make_move(6, 4, 'white')
    board.make_move(6, 5, 'white')
    # black pieces
    board.make_move(5, 3, 'black')
    board.make_move(5, 4, 'black')
